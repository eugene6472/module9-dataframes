...
new.data$X.USPersonalExpenditure
...
# Using your function, determine the highest spending category of each year# Load R's "USPersonalExpenditure" dataset using the "data()" function
# This will produce a data frame called `USPersonalExpenditure`
